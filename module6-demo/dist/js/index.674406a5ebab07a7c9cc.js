...
/* harmony default export */ const js_keyHandler = (keyHandler);
...
var update = injectStylesIntoStyleTag_default()(cjs_js_pages/* default */.Z, options);
       ...
       /* harmony default export */ const pages = (cjs_js_pages/* default */.Z && cjs_js_pages/* default.locals */.Z.locals ? cjs_js_pages/* default.locals */.Z.locals : undefined);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button{font-size:16px;font-weight:bold;transition:.2s ease-in-out;border-bottom-left-radius:20px;border-top-right-radius:20px}.active{transform:scale(0.9);opacity:.75}.text{font-family:\"Hack\",sans-serif;font-style:inherit;font-weight:bold;font-size:20px}body{display:flex;gap:20px;flex-flow:column nowrap;background-color:#8fbc8f;-webkit-user-select:none;-moz-user-select:none;user-select:none}img{width:200px;height:auto}", "",{"version":3,"sources":["webpack://./pages/index.scss"],"names":[],"mappings":"AAEA,OACC,cAAA,CACA,gBAAA,CACA,0BAAA,CACA,8BAAA,CACA,4BAAA,CAGD,QACC,oBAAA,CACA,WAAA,CAID,MACC,6BAAA,CACA,kBAAA,CACA,gBAAA,CACA,cAAA,CAGD,KACC,YAAA,CACA,QAAA,CACA,uBAAA,CACA,wBAAA,CACA,wBAAA,CACG,qBAAA,CACK,gBAAA,CAKT,IACC,WAAA,CACA,WAAA","sourcesContent":["@import \"~normalize.css\";\n\nbutton {\n\tfont-size: 16px;\n\tfont-weight: bold;\n\ttransition: .2s ease-in-out;\n\tborder-bottom-left-radius: 20px;\n\tborder-top-right-radius: 20px;\n}\n\n.active {\n\ttransform: scale(0.9);\n\topacity: 0.75;\n}\n\n\n.text {\n\tfont-family: 'Hack', sans-serif;\n\tfont-style: inherit;\n\tfont-weight: bold;\n\tfont-size: 20px;\n}\n\nbody {\n\tdisplay: flex;\n\tgap: 20px;\n\tflex-flow: column nowrap;\n\tbackground-color: darkseagreen;\n\t-webkit-user-select: none;\n\t   -moz-user-select: none;\n\t        user-select: none;\n}\n\n\n\nimg {\n\twidth: 200px;\n\theight: auto;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [114], () => (__webpack_require__(203)))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=index.674406a5ebab07a7c9cc.js.map