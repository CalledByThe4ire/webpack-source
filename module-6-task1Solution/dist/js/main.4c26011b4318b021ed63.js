...
/* harmony default export */ var js_btnHandler = (btnHandler);
...
var update = injectStylesIntoStyleTag_default()(main/* default */.Z, options);
       ...
       /* harmony default export */ var pages_main = (main/* default */.Z && main/* default.locals */.Z.locals ? main/* default.locals */.Z.locals : undefined);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button{font-size:16px;font-weight:bold;transition:.2s ease-in-out;border-bottom-left-radius:20px;border-top-right-radius:20px}.active{-webkit-transform:scale(0.9);transform:scale(0.9);opacity:.75}.text{font-family:\"Hack\",sans-serif;font-style:inherit;font-weight:bold;font-size:20px}body{display:flex;gap:20px;flex-flow:column nowrap;background-color:rgba(184,225,236,.901);-webkit-user-select:none;user-select:none}img{width:200px;height:auto}", "",{"version":3,"sources":["webpack://./pages/main.scss"],"names":[],"mappings":"AAGA,OACC,cAAA,CACA,gBAAA,CACA,0BAAA,CACA,8BAAA,CACA,4BAAA,CAGD,QACC,4BAAA,CACQ,oBAAA,CACR,WAAA,CAID,MACC,6BAAA,CACA,kBAAA,CACA,gBAAA,CACA,cAAA,CAGD,KACC,YAAA,CACA,QAAA,CACA,uBAAA,CACA,uCA7Be,CA8Bf,wBAAA,CACQ,gBAAA,CAKT,IACC,WAAA,CACA,WAAA","sourcesContent":["$c-drak-storke: rgba(184, 225, 236, 0.901);\n@import \"~normalize.css\";\n\nbutton {\n\tfont-size: 16px;\n\tfont-weight: bold;\n\ttransition: .2s ease-in-out;\n\tborder-bottom-left-radius: 20px;\n\tborder-top-right-radius: 20px;\n}\n\n.active {\n\t-webkit-transform: scale(0.9);\n\t        transform: scale(0.9);\n\topacity: 0.75;\n}\n\n\n.text {\n\tfont-family: 'Hack', sans-serif;\n\tfont-style: inherit;\n\tfont-weight: bold;\n\tfont-size: 20px;\n}\n\nbody {\n\tdisplay: flex;\n\tgap: 20px;\n\tflex-flow: column nowrap;\n\tbackground-color: $c-drak-storke;\n\t-webkit-user-select: none;\n\t        user-select: none;\n}\n\n\n\nimg {\n\twidth: 200px;\n\theight: auto;\n}"],"sourceRoot":""}]);
// Exports
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [114], function() { return __webpack_require__(884); })
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=main.4c26011b4318b021ed63.js.map